...
credits = [ "BUG_TEAM|BUG Team",
		    ...
		    "EmperorFool - Advanced Scoreboard, BUG Core and Utils, Great Person Tech Prefs,",
		    ...
		    " -    (extended BES, CDA, Civ4lerts, GP Progress Bar, PLE, Reminder, Sevopedia and Index)",
		    "Eotinb - Autolog, Reminder",
		    "Fallblau - Modified Hall of Fame Screen",
		    "fitchn - Civilopedia Index",
		    "Guarav - (extended Tech Window)",
		    ...
		    " -    City Specialists Chevons, BUG Victory Screen Additions",
