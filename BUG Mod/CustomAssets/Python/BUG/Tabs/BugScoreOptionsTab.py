...
class BugScoreOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
		...
		centerL, centerR = self.addTwoColumnLayout(screen, center, "Scores_Power_Column")
		self.addCheckboxTextDropdown(screen, centerL, centerR, "Scores__Power", "Scores__PowerFormula")
		self.addIntDropdown(screen, centerL, centerR, "Scores__PowerDecimals", True, "LAYOUT_LEFT")
		self.addColorDropdown(screen, centerL, centerR, "Scores__PowerColor", True)
		self.addFloatDropdown(screen, centerL, centerR, "Scores__PowerHighRatio", True, "LAYOUT_LEFT")
		self.addColorDropdown(screen, centerL, centerR, "Scores__PowerHighColor", True)
		self.addFloatDropdown(screen, centerL, centerR, "Scores__PowerLowRatio", True, "LAYOUT_LEFT")
		self.addColorDropdown(screen, centerL, centerR, "Scores__PowerLowColor", True)
