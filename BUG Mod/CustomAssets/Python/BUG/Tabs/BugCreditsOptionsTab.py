...
credits = [ "BUG_TEAM|BUG Team",
		    ...
		    "Alerum68 - Loading Hints & Tips, SevoPedia Strategy Guides, (options screen for PLE)",
		    ...
		    "EmperorFool - Advanced Scoreboard, GP Tech Prefs, Options Core, Power Ratio, Raw Yields",
		    " -    Whip Assist, Deployment in Military Advisor",
