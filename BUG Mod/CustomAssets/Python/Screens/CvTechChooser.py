	...
	def updateTechPrefs (self):
		...
		if (not self.bPrefsShowing):
			...
			for i, f in enumerate(FLAVORS):
				...
				screen.addDDSGFC( "GreatPerson" + str(f), pUnitInfo.getButton(), iX, PREF_ICON_TOP, PREF_ICON_SIZE, PREF_ICON_SIZE, WidgetTypes.WIDGET_GENERAL, -1, -1 )
				iX += 3 * PREF_ICON_SIZE + 2 * 16 + 48
		...
		for i, f in enumerate(FLAVORS):
			...
			if (pTech):
				screen.addDDSGFC( szButtonName, pTech.getInfo().getButton(), iX + 48, PREF_ICON_TOP, PREF_ICON_SIZE, PREF_ICON_SIZE, WidgetTypes.WIDGET_TECH_TREE, pTech.getID(), -1 )
			else:
				screen.addDDSGFC( szButtonName, self.NO_TECH_ART, iX + 48, PREF_ICON_TOP, PREF_ICON_SIZE, PREF_ICON_SIZE, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			...
			if (pTech):
				screen.addDDSGFC( szButtonName, pTech.getInfo().getButton(), iX + 2 * 48, PREF_ICON_TOP, PREF_ICON_SIZE, PREF_ICON_SIZE, WidgetTypes.WIDGET_TECH_TREE, pTech.getID(), -1 )
			else:
				screen.addDDSGFC( szButtonName, self.NO_TECH_ART, iX + 2 * 48, PREF_ICON_TOP, PREF_ICON_SIZE, PREF_ICON_SIZE, WidgetTypes.WIDGET_GENERAL, -1, -1 )
			screen.show( szButtonName )
