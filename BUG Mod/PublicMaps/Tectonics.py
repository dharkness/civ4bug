...
# COPYRIGHT 2005-2006 Laurent Di Cesare
...
def getCustomMapOptionDescAt(argsList):
	...
	selection_names = ["Earthlike (70% water)",
	                   "60% water",
	                   "Pangaea",
	                   "Lakes (30% water)",
	                   "Islands",
	...
	aridity_names = ["Arid",
	                 ...
	                 "Wet",
									 "No ice"]
	if (iOption == 0):
		return selection_names[iSelection]
	else:
		return aridity_names[iSelection]
